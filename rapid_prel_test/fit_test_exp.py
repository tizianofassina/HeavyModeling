...
def frechet_rvs_copula_logistic(alpha, size, theta=3.0):
...
data_test = frechet_rvs_copula_logistic(alpha, size = 3_000_000, theta = 3.)



gen_directory = "data_prel_test"
gen_p_T = np.log(np.load(gen_directory + "/generated_original_exp" + ".npy", allow_pickle=True))
gen_gaussian = np.log(np.load(gen_directory + "/generated_gaussian_exp" + ".npy", allow_pickle=True))
